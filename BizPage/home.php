    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center align-items-center">
        <div class="col-xl-11 d-flex align-items-center justify-content-between">
          <h1 class="logo"><a href="index.html">WorldCatalog</a></h1>
          ...
          <nav id="navbar" class="navbar">
            <ul>
              ...
              <li><a class="nav-link scrollto" href="../Produtos/cadastrar.php">Cadastrar Produto</a></li>
              <li><a class="nav-link scrollto" href="../Banco-de-Dados/controle-de-produtos/lixeira.php">Produtos Inativos</a></li>
              <li><a class="nav-link scrollto " href="../Banco-de-Dados/controle-de-produtos/listar.php">Mostrar Produtos</a></li>
              <li><a class="nav-link scrollto " href="../logout.php">Sair</a></li>
            </ul>
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active" style="background-image: url(assets/img/hero-carousel/1.jpg)">
            <div class="carousel-container">
              <div class="container">
                <h2 class="animate__animated animate__fadeInDown">Produtos Colecionáveis</h2>
                <p class="animate__animated animate__fadeInUp">Para atender as necessidades de pessoas que gostam de produtos colecionáveis, criamos um site que vai juntar diversos produtos da área de Life Style e Esportes que são dificeis de encontrar</p>
              </div>
            </div>
          </div>
